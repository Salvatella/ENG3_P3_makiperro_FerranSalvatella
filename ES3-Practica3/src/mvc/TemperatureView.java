...
public class TemperatureView implements ActionListener, Observer {
    ...
    public void enableUI() {
        ...
        this.decreaseTempButton.setEnabled(true);
        this.currentTempLabel.setEnabled(true);
        this.currentTemp.setEnabled(true);
        this.tempLabel.setEnabled(true);
        this.tempLabelView.setEnabled(true);
        this.tempOutputLabel.setEnabled(true);
    ...
    public void update(int currentTemperature, int targetTemperature) {
        ...
        this.currentTemp.setText(String.valueOf(currentTemperature));
        this.tempOutputLabel.setText(String.valueOf(targetTemperature));
